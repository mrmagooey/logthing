...
echo "========================================"
docker compose -f "$COMPOSE_FILE" up -d wef-server-10k-sustained
...
echo "========================================"
docker compose -f "$COMPOSE_FILE" stop wef-server
...
echo "========================================"
docker compose -f "$COMPOSE_FILE" stop wef-server-tls
